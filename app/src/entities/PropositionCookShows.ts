...
@Index('index_proposition_cook_shows_on_proposition_category_id', ['propositionCategoryId'], {})
@Entity('proposition_cook_shows')
export class PropositionCookShows {
  ...
  @Column('int', { name: 'project_cook_show_id', nullable: true })
  projectCookShowId: number | null;
