...
@Index('index_proposition_press_events_on_proposition_category_id', ['propositionCategoryId'], {})
@Entity('proposition_press_events')
export class PropositionPressEvents {
  ...
  @Column('int', { name: 'project_press_event_id', nullable: true })
  projectPressEventId: number | null;
