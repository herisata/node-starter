...
@Index('index_prop_product_placement_clips_on_prop_category_id', ['propositionCategoryId'], {})
@Entity('proposition_product_placement_clips')
export class PropositionProductPlacementClips {
  ...
  @Column('int', { name: 'project_product_placement_clip_id', nullable: true })
  projectProductPlacementClipId: number | null;
