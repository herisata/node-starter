...
@Index('index_proposition_animators_on_proposition_category_id', ['propositionCategoryId'], {})
@Entity('proposition_animators')
export class PropositionAnimators {
  ...
  @Column('int', { name: 'project_animator_id', nullable: true })
  projectAnimatorId: number | null;
