...
@Index('index_proposition_uncategorizeds_on_proposition_category_id', ['propositionCategoryId'], {})
@Entity('proposition_uncategorizeds')
export class PropositionUncategorizeds {
  ...
  @Column('int', { name: 'project_uncategorized_id', nullable: true })
  projectUncategorizedId: number | null;
