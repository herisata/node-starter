...
@Index('index_proposition_event_sponsors_on_proposition_category_id', ['propositionCategoryId'], {})
@Entity('proposition_event_sponsors')
export class PropositionEventSponsors {
  ...
  @Column('int', { name: 'project_event_sponsor_id', nullable: true })
  projectEventSponsorId: number | null;
