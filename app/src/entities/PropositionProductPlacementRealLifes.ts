...
@Index('index_prop_product_placement_real_lifes_on_prop_category_id', ['propositionCategoryId'], {})
@Entity('proposition_product_placement_real_lifes', {
  schema: 'genesis_staging',
})
export class PropositionProductPlacementRealLifes {
  ...
  @Column('int', {
    name: 'project_product_placement_real_life_id',
    nullable: true,
  })
  projectProductPlacementRealLifeId: number | null;
