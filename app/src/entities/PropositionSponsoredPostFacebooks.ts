...
@Index('index_prop_sponsored_post_facebooks_on_prop_category_id', ['propositionCategoryId'], {})
@Entity('proposition_sponsored_post_facebooks')
export class PropositionSponsoredPostFacebooks {
  ...
  @Column('int', { name: 'project_sponsored_post_facebook_id', nullable: true })
  projectSponsoredPostFacebookId: number | null;
