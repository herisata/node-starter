...
@Index('index_prop_sponsored_post_snapchats_on_prop_category_id', ['propositionCategoryId'], {})
@Entity('proposition_sponsored_post_snapchats')
export class PropositionSponsoredPostSnapchats {
  ...
  @Column('int', { name: 'project_sponsored_post_snapchat_id', nullable: true })
  projectSponsoredPostSnapchatId: number | null;
