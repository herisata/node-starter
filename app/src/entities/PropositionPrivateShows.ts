...
@Index('index_proposition_private_shows_on_proposition_category_id', ['propositionCategoryId'], {})
@Entity('proposition_private_shows')
export class PropositionPrivateShows {
  ...
  @Column('int', { name: 'project_private_show_id', nullable: true })
  projectPrivateShowId: number | null;
