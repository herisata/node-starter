...
@Index('index_project_uncategorizeds_on_agency_id', ['agencyId'], {})
@Index('index_project_uncategorizeds_on_admin_user_id', ['adminUserId'], {})
@Entity('project_uncategorizeds')
export class ProjectUncategorizeds {
