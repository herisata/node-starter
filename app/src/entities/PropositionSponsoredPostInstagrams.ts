...
@Index('index_prop_sponsored_post_instagrams_on_prop_category_id', ['propositionCategoryId'], {})
@Entity('proposition_sponsored_post_instagrams')
export class PropositionSponsoredPostInstagrams {
  ...
  @Column('int', {
    name: 'project_sponsored_post_instagram_id',
    nullable: true,
  })
  projectSponsoredPostInstagramId: number | null;
