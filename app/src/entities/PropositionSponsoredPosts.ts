...
@Index('index_proposition_sponsored_posts_on_proposition_category_id', ['propositionCategoryId'], {})
@Entity('proposition_sponsored_posts')
export class PropositionSponsoredPosts {
  ...
  @Column('int', { name: 'project_sponsored_post_id', nullable: true })
  projectSponsoredPostId: number | null;
